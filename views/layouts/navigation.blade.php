<nav x-data="{ open: false }" class="bg-yellow-200 border-b border-yellow-600">
        ...
        <div class="flex justify-between h-16">
            <div class="flex w-full">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-10 w-auto fill-current text-yellow-900" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-yellow-900 hover:text-yellow-900 hover:border-yellow-900 focus:outline-none focus:text-yellow-900 focus:border-yellow-900 transition duration-150 ease-in-out">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-yellow-900 hover:text-yellow-900 hover:bg-yellow-900 focus:outline-none focus:bg-yellow-900 focus:text-yellow-900 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-yellow-900">
            <div class="px-4">
                <div class="font-medium text-base text-yellow-800">{{ Auth::user()->name }}</div>
                <div class="font-medium text-sm text-yellow-900">{{ Auth::user()->email }}</div>
            </div>
